    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#submmitBtn").click(function () {
                ...
                $("#activityId").val($xz.val());
                $("#activityName").val($("#"+$xz.val()).html());
            ...
            $("#convertBtn").click(function (){
                if($("#isCreateTransaction").prop("checked")){
                    ...
                    window.location.href="convert.do?clueId="+$("#clueId").val();
                }
            })
    ...
    <div class="modal-dialog" role="document" style="width: 90%;">
        <div class="modal-content">
                ...
                <div class="btn-group" style="position: relative; top: 18%; left: 8px;">
                    <form class="form-inline" role="form">
                        <div class="form-group has-feedback">
                            <input type="text" id="searchBtn" class="form-control" style="width: 300px;"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="submmitBtn">提交</button>
            </div>
        </div>
    </div>
</div>
...
<div id="create-transaction2"
    ...
    <form action="convert.do" id="tranForm" method="post">
        <input type="hidden" class="form-control" id="flag"  name="flag">
        <input type="hidden" class="form-control" id="clueId" name="clueId" value="${param.id}">
