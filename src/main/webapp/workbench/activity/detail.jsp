                ...
                $.ajax({
                    ...
                    success:function (data){
                        if (data.success){
                            ...
                            html += '    <img title="${a.owner}" src="${pageContext.request.contextPath}/image/user-thumbnail.png" style="width: 30px; height:30px;">';
                            html += '        <div style="position: relative; top: -40px; left: 40px;" >';
                            html += '            <h5 id="e'+data.r.id+'">' + data.r.noteContent + '</h5>';
                            html += '            <font color="gray">市场活动</font> <font color="gray">-</font> <b>"${a.name}"</b> <small style="color: gray;"> ' + data.r.createTime + ' 由 ' + data.r.createBy + '</small>';
                            html += '            <div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
                            html += '                <a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #FF0000;" onclick="editRemark(\''+data.r.id+'\')"></span></a>';
                            html += '                &nbsp;&nbsp;&nbsp;&nbsp;';
                            html += '                <a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #FF0000;" onclick="deleteRemark(\''+data.r.id+'\')"></span></a>';
                            html += '            </div>';
                            html += '        </div>';
                            html += '</div>';
                ...
                $.ajax({
                  ...
                  success:function (data){
                     ...
                     if (data.success){
                         ...
                         html += '        <div style="position: relative; top: -40px; left: 40px;" >';
                         html += '            <h5 id="e'+data.r.id+'">' + data.r.noteContent + '</h5>';
                         html += '            <font color="gray">市场活动</font> <font color="gray">-</font> <b>"${a.name}"</b> <small style="color: gray;"> ' + data.r.editTime + ' 由 ' + data.r.editBy + '</small>';
                         html += '            <div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
                         html += '                <a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #FF0000;" onclick="editRemark(\''+data.r.id+'\')"></span></a>';
                         html += '                &nbsp;&nbsp;&nbsp;&nbsp;';
                         html += '                <a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #FF0000;" onclick="deleteRemark(\''+data.r.id+'\')"></span></a>';
...
<div style="position: relative; left: 40px; top: -30px;">
    <div class="page-header">
        <h3>市场活动 <small>2021-10-10 ~ 2022-10-20</small></h3>
    </div>
