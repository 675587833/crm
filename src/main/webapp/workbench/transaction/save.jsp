...
<form class="form-horizontal" action="save.do" method="post" id="tranForm" role="form" style="position: relative; top: -30px;">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" id="create-activityName" value="发传单">
            <input type="hidden" class="form-control" id="create-activityId" name="activityId"
                   value="7b8696a8d5d549898cf7114aa992a66e">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            ...
            <input type="hidden" class="form-control" id="create-contactsId" name="contactsId"
                   value="ddbc741112fc40dea2089ea829ba13c7">
